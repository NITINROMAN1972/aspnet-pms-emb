            ...
            <div class="mx-auto col-md-11">
                    ...
                    <div class="justify-content-end d-flex mb-0 mt-4">
                        ...
                        <div class="col-md-6 text-end">
                            <div class="fw-semibold fs-5">
                                <asp:Button ID="btnNewRaBill" runat="server" Text="New RA Bill +" OnClick="btnNewRaBill_Click" CssClass="btn btn-custom text-white shadow" />
                            </div>
                        </div>
                    </div>
                ...
                <div id="gridRaUpdateDiv" visible="false" runat="server" class="mt-5">
                    <asp:GridView ShowHeaderWhenEmpty="true" ID="gridRaHeader" runat="server" AutoGenerateColumns="false" OnRowCommand="GrdUser_RowCommand" AllowPaging="true" PageSize="10"
                        CssClass="table table-bordered border border-1 border-dark-subtle table-hover text-center grid-custom" OnPageIndexChanging="GridEmbHeader_PageIndexChanging" PagerStyle-CssClass="gridview-pager">
                        ...
                        <div id="gridEmbDiv" runat="server" visible="false" class="mt-5">
                            ...
                            <div class="border-top border-bottom border-secondary-subtle py-3 my-4">
                                <div class="fw-normal fs-5 fw-medium text-body-secondary">
                                    <asp:Literal Text="EMB Abstract Items List" runat="server"></asp:Literal>
                                </div>
                            </div>
                            ...
                            <div class="border-top border-bottom border-secondary-subtle py-3 my-4">
                                <div class="fw-normal fs-5 fw-medium text-body-secondary">
                                    <asp:Literal Text="Taxes / Charges" runat="server"></asp:Literal>
                                </div>
                            </div>
